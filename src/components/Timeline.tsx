    ...
    <div className="flex h-full bg-nexus-950">
      ...
      <div className="w-1/3 min-w-[320px] border-r border-nexus-border overflow-y-auto bg-nexus-900/50">
        <div className="p-6 sticky top-0 bg-nexus-950/95 backdrop-blur z-10 border-b border-nexus-border">
          <h2 className="text-xl font-bold text-white mb-1">Evolution</h2>
          <p className="text-sm text-gray-500 mb-4">Tracking concept drift and knowledge milestones.</p>
          ...
          >
            ...
            <span className="text-sm font-medium">
                {isGeneratingReport ? 'Synthesizing...' : 'Generate Monthly Report'}
            </span>
          </button>
        </div>
        ...
        {report ? (
             <div className="max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button onClick={() => setReport(null)} className="text-sm text-gray-500 hover:text-white">Close Report</button>
                </div>
          ...
          <div className="max-w-3xl mx-auto">
             <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <div className="text-sm text-gray-500 font-mono mt-1">Event ID: {selectedEvent.id} • {selectedEvent.date}</div>
                </div>
             </div>
            ...
            {selectedEvent.diffSummary && (
                <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-red-900/10 border border-red-900/30 p-4 rounded-lg">
                        <div className="text-xs font-bold text-red-400 mb-2 uppercase">Previously</div>
                    ...
                    <div className="bg-green-900/10 border border-green-900/30 p-4 rounded-lg -ml-[100%] z-10">
                         <div className="text-xs font-bold text-green-400 mb-2 uppercase">Evolved To</div>
             ...
             <div>
                 <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">Impacted Files</h3>
